 ...
 *
 */
public class DocLevelFeature1030 extends DocLevelFeature {

    final static Float probThresh = 0.1f;

    public DocLevelFeature1030() {
        setIndex(1030);
        setDescription("average number of translations per source word in the document (threshold in giza1: prob > 0.1) weighted by the frequency of each word in the source corpus");
