 ...
 *
 */
public class DocLevelFeature1093 extends DocLevelFeature {

    public DocLevelFeature1093() {
        this.setIndex(1093);
        this.setDescription("ratio of percentage of verbs in the source and target documents");
    ...
    public void run(Doc source, Doc target) {
        ...
        for (int i=0;i<source.getSentences().size();i++){
            noContent+=(Integer) source.getSentence(i).getValue("verbs");
        ...
        for (int i=0;i<target.getSentences().size();i++){
            ...
            noContent = (Integer) target.getSentence(i).getValue("verbs");
        }
