...
public class WordLevelFeature1022 extends WordLevelFeature {

    public WordLevelFeature1022() {
        this.setIndex("WCE1022");
        this.setIdentifier("TRGPOSTRIGRAMMID");
        this.setDescription("Middle trigram of POS tags of target word.");
    ...
    public void run(Sentence source, Sentence target) {
        ...
        for (int i = 0; i < tokens.length; i++) {
            String ngram = this.getNgram(targetPOSTags, i, 1, 1);
