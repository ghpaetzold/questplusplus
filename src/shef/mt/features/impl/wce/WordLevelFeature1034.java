...
public class WordLevelFeature1034 extends WordLevelFeature {

    private double t;
    public final Float[] PROBS_VALUES = new Float[]{0.05f, 0.10f, 0.20f, 0.50f};

    public WordLevelFeature1034() {
        t = 0.10;
        this.setIndex("WCE1034");
        this.setIdentifier("TRCOUNT10");
        this.setDescription("Number of translations of each target word given a probability threshold of 10%.");
