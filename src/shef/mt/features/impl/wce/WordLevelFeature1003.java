...
public class WordLevelFeature1003 extends WordLevelFeature{

    public WordLevelFeature1003() {
        this.setIndex("WCE1003");
        this.setIdentifier("TRGBIGRAMRIGHT");
        this.setDescription("Bigram at right of target word.");
    }
    ...
    public void run(Sentence source, Sentence target) {
        ...
        for(int i=0; i<tokens.length; i++){
            String ngram = this.getNgram(tokens, i, 0, 1);
