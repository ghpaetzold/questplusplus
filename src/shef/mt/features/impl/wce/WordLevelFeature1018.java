...
public class WordLevelFeature1018 extends WordLevelFeature {

    public WordLevelFeature1018() {
        this.setIndex("WCE1018");
        this.setIdentifier("TRGPOSBIGRAMLEFT");
        this.setDescription("Left bigram of POS tags of target word.");
    ...
    public void run(Sentence source, Sentence target) {
        ...
        for (int i = 0; i < tokens.length; i++) {
            String ngram = this.getNgram(targetPOSTags, i, 1, 0);
