...
public class WordLevelFeature1036 extends WordLevelFeature {

    private double t;
    public final Float[] PROBS_VALUES = new Float[]{0.05f, 0.10f, 0.20f, 0.50f};

    public WordLevelFeature1036() {
        t = 0.50;
        this.setIndex("WCE1036");
        this.setIdentifier("TRCOUNT50");
        this.setDescription("Number of translations of each target word given a probability threshold of 50%.");
